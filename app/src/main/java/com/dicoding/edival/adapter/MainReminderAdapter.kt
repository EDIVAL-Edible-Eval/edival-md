...
class MainReminderAdapter(private val reminderList: List<Reminder>) : RecyclerView.Adapter<MainReminderAdapter.MyViewHolder>(){
        ...
        query.get().addOnSuccessListener { querySnapshot ->
            for (document in querySnapshot.documents) {
                ...
                holder.itemView.setOnClickListener {
                    // Ambil ID reminder dari currentReminder
                    // Pindah ke DetailActivity dengan mengirim ID reminder
